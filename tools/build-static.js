...
const operatorAssets=JSON.parse(read('data/operator-assets.json'));
write('js/operator-asset-data.js',`window.TRT_OPERATOR_ASSETS=${JSON.stringify(operatorAssets.operators)};\n`);
...
const routeSymbols=JSON.parse(read('data/route-symbol-assets.json'));
write('js/route-symbol-data.js',`window.TRT_ROUTE_SYMBOL_ASSETS=${JSON.stringify(routeSymbols.assets)};\n`);
