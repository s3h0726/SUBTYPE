...
write('js/service-data.js',`/* AUTO-GENERATED. DO NOT EDIT. */\nwindow.TRT_TOKYO_AREA=${JSON.stringify(tokyoArea)};\nwindow.TRT_SERVICE_CATALOG=${JSON.stringify(services.routes)};\nwindow.TRT_TOKYO_SERVICE_PATTERNS=${JSON.stringify(tokyoServicePatterns)};\nwindow.TRT_KOREAN_OVERRIDES=${JSON.stringify(korean.stations)};\n`);
...
html=html.replace(/(\.\/js\/service-data\.js)(?:\?v=[^"']*)?/g,`$1?v=${digest(read('js/service-data.js'))}`);
