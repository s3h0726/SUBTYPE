...
const order=['utils.js','rail-data-repository.js','storage.js','typing.js','statistics-engine.js','line-badge.js','station-sign-templates.js','route-integrity.js','route-renderer.js','game.js','statistics.js','network-map.js','data-loader.js','route-editor.js','auth.js','app.js'];
...
const digest=value=>crypto.createHash('sha256').update(value).digest('hex').slice(0,12),workspaceBrowser=read('js/line-workspace-data.js');
