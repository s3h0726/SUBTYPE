...
/* Runtime asset bridge. The canonical files are the source of truth; this only keeps
   checked-in embedded workspace data in sync until the next full local build. */
(()=>{
  ...
  const makeAsset=(file,version='20260913')=>({asset:`${file}?v=${version}`,file,version,exists:true,verified:true,source:'',officialExists:true});
  ...
  const tokyoMetroLines={
    'line-28001':makeAsset('./data/lines/tokyo-metro/ginza/symbol.svg','ea1fd2718b8c'),
    'line-28002':makeAsset('./data/lines/tokyo-metro/marunouchi-line/symbol.svg'),
    'line-28003':makeAsset('./data/lines/tokyo-metro/hibiya-line/symbol.svg'),
    'line-28004':makeAsset('./data/lines/tokyo-metro/tozai-line/symbol.svg'),
    'line-28005':makeAsset('./data/lines/tokyo-metro/chiyoda-line/symbol.svg'),
    'line-28006':makeAsset('./data/lines/tokyo-metro/yurakucho-line/symbol.svg'),
    'line-28008':makeAsset('./data/lines/tokyo-metro/hanzomon-line/symbol.svg'),
    'line-28009':makeAsset('./data/lines/tokyo-metro/namboku-line/symbol.svg'),
    'line-28010':makeAsset('./data/lines/tokyo-metro/fukutoshin-line/symbol.svg','473dc161fd82')
  };
  ...
  for(const route of data.routes||[]){
    ...
    if(tokyoMetroLines[route.id]){
      route.symbolAsset=tokyoMetroLines[route.id];
      route.symbolMeta={...(route.symbolMeta||{}),asset:'./symbol.svg',officialSymbolExists:true,verified:true};
      route.officialSymbolExists=true;
    }
  }
