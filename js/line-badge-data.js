...
(()=>{
  ...
  const commonsAsset=(filename)=>{
    ...
    return {asset:file,file,version:'commons-20260913',exists:true,verified:false,source,assetSource:'wikimedia-commons',assetSourceUrl:source,officialExists:true};
  };
